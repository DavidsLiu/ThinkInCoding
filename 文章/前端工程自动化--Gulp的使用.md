...
####建议
  因为这主要是个工具，就是配置写的比较麻烦，里面插件的用法还是看看官网上的介绍，用起来会更好一点。然后我们写了一个简单的配置[demo]，有兴趣的同学可以去看看(先看readme.md)，楼主建议，像这种工具类的技能还是要多练习练习，光看是没用的，而且每个项目最后的构建方式不一定一样。
